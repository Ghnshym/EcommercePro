            ...
            <div class="content-wrapper">
                ...
                <form action="{{ url('/update_product_confirm', $product->id) }}" method="post"  enctype="multipart/form-data">
                    ...
                    <div class="div_design">
                        ...
                        <input class="text_color" type="text" name="title" placeholder="Enter a title" required value="{{ $product->title }}">
                    </div>
                    <div class="div_design">
                        <label>Product Description :</label>
                        <input class="text_color" type="text" name="description" placeholder="Enter a description " required value="{{ $product->description }}">
                    </div>
                    <div class="div_design">
                    ...
                    <div class="div_design">
                        ...
                        <img style="margin: auto;" src="/product/{{ $product->image }}" alt="" width="100" height="100">
                    </div>
